...
ggsave(product_bar, file="../../report/graph_output/product_bar.png", width=30, height=20, units = "cm")
...
ggsave(back_bar, file="../../report/graph_output/back_bar.png", width=30, height=20, units = "cm")
...
ggsave(bigdata_bar, file="../../report/graph_output/bigdata_bar.png", width=30, height=20, units = "cm")
...
ggsave(salary_line, file="../../report/graph_output/salary_line.png", width=32, height=18, units = "cm")
...
ggsave(dep_boxplot, file="../../report/graph_output/dep_boxplot.png", width=32, height=18, units = "cm")
